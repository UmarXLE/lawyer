    ...
    КОНСАЛТИНГОВАЯ КОМПАНИЯ</span></p>
            ...
            <div className={css.footer__social}>
                ...
                <div className={css.footer__social_container}>
                    <a target='_blank' href="https://www.instagram.com/algorithmprime/"><img src={instagrammIcon} alt="imgInst"/></a>
                    <a target='_blank'  href="https://wa.me/+996999660996"><img src={whatsAppIcon} alt="imgWhatsApp"/></a>
                    <a target='_blank'  href="https://web.telegram.org/k/#@semetei_ryspaev"><img src={telegramIcon} alt="imgTg"/></a>
                </div>
            </div>
        </footer>
    );
